...
class ErrorHandlingMiddleware:
    ...
    def process_exception(self, request, exception):
        # Здесь вы можете выполнить дополнительные действия д
        # ля обработки ошибки Например, записать информацию об
        # ошибке в журнал или отправить уведомление администратору
