...
urlpatterns = [
    ...
    path('products/import-csv/', ImportCSV.as_view(),
         name='products_from_csv'),
    path('products/export-csv-sample/', export_csv_template,
         name='export_template_csv'),
    path('add_to_favourite/<uuid:pk>/', AddOrRemoveFavoriteProduct.as_view(),
